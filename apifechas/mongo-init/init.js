conn = new Mongo();
// Conexión a la base de datos y creación de la base de datos 'festivos'
db = connect("localhost:27017/festivos");
// Crear la colección 'tipos' e insertar documentos
db.tipos.insertMany([
    {
    ...
    {
        id: 3, tipo: 'Variable', modoCalculo: 'Según Pascua',
        festivos: [
            { dia: 0, mes: 0, nombre: 'Domingo de Ramos', diasPascua: -7 },
    ...
    {
        id: 4, tipo: 'Variable', modoCalculo: 'Según Pascua',
        festivos: [
...
// Crear otra colección de ejemplo y agregar un documento
db.createCollection('yourCollectionName');
db.yourCollectionName.insert({ key: 'value' });

// Mensaje de confirmación
print("Base de datos 'festivos' inicializada y actualizada correctamente.");
